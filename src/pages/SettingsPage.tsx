    ...
    <div className="space-y-4">
      ...
      <section className="card space-y-3">
        ...
        <p className="text-xs text-slate-400">
          Nombres e imágenes de las cartas se cargan siempre desde el catálogo público de
          swu-db.com cuando hay conexión (y se guardan en caché para futuras consultas offline).
          Si no hay conexión, o una carta no está en el catálogo, la comprobación sigue
          funcionando igualmente solo con los códigos de carta.
        </p>
      </section>

      <section className="card space-y-3">
        <h2 className="font-display text-base">Copia de seguridad</h2>
      ...
      <section className="card space-y-3">
        <h2 className="font-display text-base text-saber-red">Zona de riesgo</h2>
        <div className="flex flex-wrap gap-2">
